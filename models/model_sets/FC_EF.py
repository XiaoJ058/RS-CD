...
class SSCDl(nn.Module):
    def __init__(self, in_ch=3, out_ch=1, use_dropout=False):
        super().__init__()
        self.conv1 = nn.Sequential(nn.Conv2d(in_ch*2, in_ch, kernel_size=1, stride=1, padding=0, bias=False),
...
if __name__ == '__main__':
    Net = SSCDl(3, 1)
    # X1 = torch.rand(size=(1, 3, 512, 512))
    # X2 = torch.rand(size=(1, 3, 512, 512))
